...
class Node {
  ...
  Node(String _name, String _child1, String _child2) {
    ...
    if(int(name) == 1) screenLocation = new PVector(width/4, 190);
    if(int(name) == 2) screenLocation = new PVector(width/4 - 170, 125);
    if(int(name) == 3) screenLocation = new PVector(width/4 + 370, 175);
    if(int(name) == 8) screenLocation = new PVector(3*width/4, 120);
    fillColor = 0;
